  ...
  <div id="portfolio" class="our-portfolio section">
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h2>Our Recent <em>NFT Project</em> &amp; Case Studies <span>for Clients</span></h2>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mt-s">
          <div class="item-details">
            <div class="item-cat">NFT Crypto Art</div>
            <h2>Interactive Collectible universe of Dogs</h2>
            <p>Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod
            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veni am,
            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
            consequat.</p>
            <div class="details-list">
                <p>Artist : <span>Andy Smith</span></p>
                <p>Size : <span>3000 x 3000</span></p>
                <p>Created : <span>04 April , 2021</span></p>
                <p>Collection: <span>Cyberpunk City Art</span></p>
            </div>
            <div class="main-red-button-hover"><a href="#">Purchase from Rarible</a></div>
          </div>
        </div>
        <div class="col-lg-3 mt-s">
          <div class="fact-item v2 mb-30">
