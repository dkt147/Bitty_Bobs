    ...
    <div class="wrapper">
                    ...
                    <div class="col-md-7">
                        <div class="card pl-5" style="padding-left: 500px;">
                            <div class="card-header">
                                <h3 class="title">Update RoadMap</h3>
                            </div>
                            <div class="card-body">
                                <?php
       ...
       include 'connection.php';      
        //Getting data to edit...
                                ...
                                ?>
                                    <!--Form-->
                                            <form action="updateroadmap.php" method="POST">
                                                <div class="row">
...
<div class="col-md-6 pr-md-1">
    <div class="form-group">
        <label>Roadmap 7</label>
        <input type="text" class="form-control" value="<?php echo $row['r7']; ?>" name="r7" required>
    </div>
</div>
