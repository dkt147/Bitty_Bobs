...
<body class="">
    ...
    //Checking if type field is empty...
        ...
        //Insert Query For Mysql...
            $query = "INSERT INTO `testing_type`(`testing_type`) VALUES ('{$type}')";
                    ...
                    <div class="col-md-7">
                        <div class="card pl-5" style="padding-left: 500px;">
                            <div class="card-header">
                                <h3 class="title">Add Testing Type</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="createtype.php" method="POST">
                                    <div class=" row">
                                        <div class="col-md-6 pr-md-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="type" placeholder="Testing type" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 pr-md-1">
                                            <input type="submit" class="btn btn-fill btn-success" name="createtype" value="Add">
