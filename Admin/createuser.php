                        ...
                        <div class="card pl-5" style="padding-left: 500px;">
                            ...
                            <div class="card-body">
                                ...
                                <form action="createuser.php" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 pr-md-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="User Name" required pattern="[a-zA-Z0-9]+">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 pr-md-1">
                                            <input type="submit" class="btn btn-fill btn-success" name="createuser" value="Create">
