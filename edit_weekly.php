                ...
                <div class="col-md-7">
                    <div class="card pl-5" style="padding-left: 500px;">
                        <div class="card-header">
                            <h3 class="title">Update Weekly Data</h3>
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            if (isset($_GET['id'])) {
                                ...
                                $query = "SELECT * FROM `o_weekly_data` Where id = {$eid}";
                                ...
                                if (mysqli_num_rows($res) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($res)) {
                                        ...
                                        <!--Form-->
                                        <form action="updateweekly.php" method="POST">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 pr-md-1">
                                                    <div class="form-group">
                                                        <label>Week</label>
                                                        <input type="text" class="form-control" value="<?php echo $row['week']; ?>" disabled>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 pr-md-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" name="date" value="<?php echo $row['date']; ?>" style="background-color:white;color:#000;" min="<?php echo $minDate; ?>" max="<?php echo $maxDate; ?>">
